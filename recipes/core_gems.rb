...
if platform?('mac_os_x')
  execute 'Installing bundler, pg, rails for 2.0.0-p247' do
    ...
    command 'export RBENV_ROOT=/usr/local/var/rbenv;export PATH=$RBENV_ROOT/shims:$RBENV_ROOT/bin:/usr/local/bin:/usr/local/sbin:$PATH;rbenv shell 2.0.0-p247;export GEM_PATH=/usr/local/var/rbenv/versions/2.0.0-p247/lib/ruby/gems/2.0.0;export GEM_HOME=/usr/local/var/rbenv/versions/2.0.0-p247/lib/ruby/gems/2.0.0;echo `ruby -v`;gem env;gem install bundler pg rails rspec thor unicorn guard'
  ...
  execute 'Installing bundler, pg, rails, puma for jruby-1.7.4' do
    user node['current_user']
    command 'export RBENV_ROOT=/usr/local/var/rbenv;export PATH=$RBENV_ROOT/shims:$RBENV_ROOT/bin:/usr/local/bin:/usr/local/sbin:$PATH;;rbenv shell jruby-1.7.4;export GEM_PATH=/usr/local/var/rbenv/versions/jruby-1.7.4/lib/ruby/gems/shared;export GEM_HOME=/usr/local/var/rbenv/versions/jruby-1.7.4/lib/ruby/gems/shared;$RBENV_ROOT/shims/gem install bundler jdbc-postgres rails rspec thor puma guard'
  end
